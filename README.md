Файл sentiment_final содержит итоговую модель для решения задачи анализа тональности текста, также приложены таблицы example, которые мы не успели отправить.
